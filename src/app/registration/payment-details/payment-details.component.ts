...
export class PaymentDetailsComponent implements OnInit {
  ...
  submitPaymentDetails() {
    ...
    this.paymentDetails = this.registerForm.value
    this.service.paymentDetails = this.paymentDetails
  ...
  submitDetails() {
    ...
    this.registrationDetails = {
      clientDetails: this.service.clientDetails,
      businessDetails: this.service.businessDetails,
      paymentDetails: this.service.paymentDetails,
    };
